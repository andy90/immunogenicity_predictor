...
write.table(x = corrs, row.names = FALSE, quote = FALSE, file = here("model_train_test/acute/res_allmodels","corrs.txt"))
write.table(x = corrs_mean, row.names = FALSE, quote = FALSE, file = here("model_train_test/acute/res_allmodels","corrs_mean.txt"))
...
write.table(x = aucs, row.names = FALSE, quote = FALSE, file = here("model_train_test/acute", paste("res_allmodels/aucs", dom_crit, ".txt", sep = "")))
write.table(x = aucs_mean, row.names = FALSE, quote = FALSE, file = here("model_train_test/acute", paste("res_allmodels/aucs_mean", dom_crit, ".txt", sep = "")))

write.table(x = tprs_full, row.names = FALSE, col.names = FALSE, quote = FALSE, file = here("model_train_test/acute", paste("res_allmodels/tprs_full", dom_crit, ".txt", sep = "")))

write.table(data.frame(fpr), row.names = FALSE, col.names = FALSE, file = here("model_train_test/acute", paste("res_allmodels/fpr_full", dom_crit, ".txt", sep = "")))

write.table(x = cbind(as, bs), row.names = FALSE, col.names = FALSE, quote = FALSE, file = here("model_train_test/acute", paste("res_allmodels/ab_full", dom_crit, ".txt", sep = "")))
